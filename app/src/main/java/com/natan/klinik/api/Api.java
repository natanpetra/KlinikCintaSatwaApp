...
public class Api {
    ...
    public static String Hotel = "https://madiun.buatsoftware.com/api/pos-polisi";
    public static String Samsat = "https://madiun.buatsoftware.com/api/samsat";
    public static String Kantor = "https://madiun.buatsoftware.com/api/kantor-polisi";
