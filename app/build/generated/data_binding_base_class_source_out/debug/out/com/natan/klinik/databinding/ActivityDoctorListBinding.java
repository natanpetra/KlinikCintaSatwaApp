...
public final class ActivityDoctorListBinding implements ViewBinding {
  ...
  private ActivityDoctorListBinding(@NonNull CoordinatorLayout rootView,
      @NonNull RecyclerView rvDoctor, @NonNull Toolbar toolbar) {
    this.rootView = rootView;
    this.rvDoctor = rvDoctor;
  ...
  public static ActivityDoctorListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rvDoctor;
      RecyclerView rvDoctor = ViewBindings.findChildViewById(rootView, id);
      if (rvDoctor == null) {
        break missingId;
      }
      ...
      return new ActivityDoctorListBinding((CoordinatorLayout) rootView, rvDoctor, toolbar);
    }
