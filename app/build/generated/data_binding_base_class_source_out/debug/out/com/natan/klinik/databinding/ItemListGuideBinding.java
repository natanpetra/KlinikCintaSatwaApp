...
public final class ItemListGuideBinding implements ViewBinding {
  @NonNull
  ...
  private ItemListGuideBinding(@NonNull RelativeLayout rootView, @NonNull ImageView arrow,
      @NonNull ImageView imgHotel, @NonNull RelativeLayout rlHotel,
      @NonNull RelativeLayout rlListHotel, @NonNull TextView tvTitle) {
  ...
  @NonNull
  public static ItemListGuideBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemListGuideBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_list_guide, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemListGuideBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListGuideBinding((RelativeLayout) rootView, arrow, imgHotel, rlHotel,
          rlListHotel, tvTitle);
    }
