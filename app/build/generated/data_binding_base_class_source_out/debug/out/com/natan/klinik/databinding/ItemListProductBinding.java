...
public final class ItemListProductBinding implements ViewBinding {
  ...
  private ItemListProductBinding(@NonNull RelativeLayout rootView, @NonNull ImageView arrow,
  ...
  @NonNull
  public static ItemListProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemListProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_list_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemListProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListProductBinding((RelativeLayout) rootView, arrow, imgHotel, rlHotel,
